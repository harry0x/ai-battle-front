...
const sampleData = {
  ...
  judge: {
    ...
    solution_1_reasoning:
      "The **iterative approach** is highly recommended for JavaScript. It avoids call stack limitations, handles negative inputs by returning `NaN` (mathematically correct), and is generally more memory efficient for large values.",
    solution_2_reasoning:
      "The **recursive approach** is elegant and mirrors the mathematical definition closely. However, it risks stack overflow for large inputs and returns `undefined` instead of `NaN` for negative numbers, which is less semantically correct.",
  },
};
...
export default function App() {
  ...
  const handleSubmit = (question) => {
    ...
    // Simulate API call
    setTimeout(() => {
      setMessages((prev) => [...prev, { ...sampleData, problem: question }]);
      setLoading(false);
    }, 1500);
  };
          ...
          {messages.length === 0 && !loading && (
            <div className="flex flex-col items-center justify-center min-h-[60vh] animate-fade-up">
              ...
              <p className="text-sm text-text-secondary mb-10 text-center max-w-sm leading-relaxed">
                Ask a coding question and get two independent solutions with an
